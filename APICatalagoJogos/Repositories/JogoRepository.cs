...
namespace APICatalagoJogos.Repositories
{
    public class JogoRepository : IJogoRepository
    {
        ...
        {
            {Guid.Parse("0ca314a5-9282-45d8-92c3-2985f2a9fd04"), new Jogo{ Id = Guid.Parse("0ca314a5-9282-45d8-92c3-2985f2a9fd04"), Nome = "Assassin's Creed Valhalla", Produtora = "Ubisoft", Preco = 200} },
            {Guid.Parse("eb909ced-1862-4789-8641-1bba36c23db3"), new Jogo{ Id = Guid.Parse("eb909ced-1862-4789-8641-1bba36c23db3"), Nome = "Assassin's Creed Odyssey", Produtora = "Ubisoft", Preco = 150} },
            {Guid.Parse("5e99c84a-108b-4dfa-ab7e-d8c55957a7ec"), new Jogo{ Id = Guid.Parse("5e99c84a-108b-4dfa-ab7e-d8c55957a7ec"), Nome = "Assassin's Creed Origins", Produtora = "Ubisoft", Preco = 100} },
